...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleSameIdNumberException(SameIdNumberException ex, WebRequest webRequest) {
        return getErrorResponse(ex, webRequest, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler
    public final ResponseEntity<Object> handleCustomerDoesNotExistException(CustomerDoesNotExistException ex, WebRequest webRequest) {
        return getErrorResponse(ex, webRequest, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler
    public final ResponseEntity<Object> handleIDNumberAndBirthDateNotMatchException(IDNumberAndBirthDateNotMatchException ex, WebRequest webRequest) {
        return getErrorResponse(ex, webRequest, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler
    public final ResponseEntity<Object> handleApprovedApplicationException(ApprovedApplicationException ex, WebRequest webRequest) {
        return getErrorResponse(ex, webRequest, HttpStatus.BAD_REQUEST);
    }
