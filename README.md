...
Customer information is received. With the ID number, the credit score service is assumed to be written before, and the credit score of the relevant person is taken and the credit result and credit limit are shown to the user.
